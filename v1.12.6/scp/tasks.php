...
$ost->addExtraHeader('<script type="text/javascript" src="js/ticket.js?e351ba5"></script>');
$ost->addExtraHeader('<script type="text/javascript" src="js/thread.js?e351ba5"></script>');
$ost->addExtraHeader('<meta name="tip-namespace" content="tasks.queue" />',
    "$('#content').data('tipNamespace', 'tasks.queue');");

if($task) {
    $ost->setPageTitle(sprintf(__('Tarefa #%s'),$task->getNumber()));
