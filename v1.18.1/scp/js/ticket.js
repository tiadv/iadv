...
+function( $ ) {
  ...
  Lock.prototype = {
    ...
    warn: function() {
      $.messageBar.show(
        __('Seu bloqueio ira expirar em breve'),  //iAdv
        __('Este bloqueio evita que outros alterem enquanto você está aqui. Quer renovar?'), //iAdv
        {onok: this.wakeup.bind(this), buttonText: __("Sim")} //iAdv
      ).addClass('warning');
    },
